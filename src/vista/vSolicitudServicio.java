...
import controlador.*;
import vista.*;
public class vSolicitudServicio extends javax.swing.JFrame {
    /**
     * Creates new form VProducto
     */
    public vSolicitudServicio() {
        initComponents(); 
    }
   // mRecepcionPrenda modelo = new mRecepcionPrenda();
    ...
    private void initComponents() {
        ...
        setTitle("Formulario Solicitud de Servicio");
        ...
        jLabel2.setText("Formulario Solicitud de Servicio");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(450, 10, 360, 30);
        ...
        jLabel1.setText("        Detalles Solicitud de Servicio");
        jPanel3.add(jLabel1);
        jLabel1.setBounds(410, 10, 730, 30);

        SeleccionarServicio.setFont(new java.awt.Font("Purisa", 1, 12)); // NOI18N
        SeleccionarServicio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vista/buscar.png"))); // NOI18N
        SeleccionarServicio.setText(" Catalogo Servicio Prenda");
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vista/buscar.png"))); // NOI18N
        ...
        CampoFecha.setBounds(1080, 10, 110, 30);
 ...
 this.Guardar.setEnabled(true);       
  this.BotonEliminardetalle.setEnabled(true);
    ...
    private void jButton2FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jButton2FocusGained
        this.CodRecepcion.setText(VClientes.Id);
      //  this.FechaRec.setText(VBuscaRecepcion.fecha);
       // this.DescriEquipo.setText(VBuscaRecepcion.equipo);
        this.Cliente.setText(VClientes.Cliente);
        this.Ci.setText(VClientes.ci);
        // TODO add your handling code here:

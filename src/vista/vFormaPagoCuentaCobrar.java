...
import modelo.*;
import controlador.*;
public class vFormaPagoCuentaCobrar extends javax.swing.JFrame {
	VBuscaCuentaCobrar dfd;
       /**
     * Creates new form VProducto
     */
    public vFormaPagoCuentaCobrar() {
        initComponents(); 
    }
...
this.CampoCodigo1.setText(dfd.sd);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {      
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cFormaPagoCuentaCobrar(new vFormaPagoCuentaCobrar()).iniciar();
            }
        });
    }

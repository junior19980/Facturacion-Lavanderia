...
import modelo.*;
import controlador.*;
public class vFacturaVenta1 extends javax.swing.JFrame {
   static String Id= "";
    /**
     * Creates new form VProducto
     */
    public vFacturaVenta1() {
        initComponents(); 
    }
   // mRecepcionPrenda modelo = new mRecepcionPrenda();
    ...
    private void initComponents() {
        ...
        SeleccionarRecepcion.setText("Buscar Servicio");
        ...
        jLabel21.setBounds(980, 100, 60, 30);
        ...
        jButton3.setBounds(70, 120, 160, 30);
        ...
        jTextField8.setBounds(230, 120, 50, 30);

        jTextField9.setEditable(false);
        getContentPane().add(jTextField9);
        jTextField9.setBounds(280, 120, 100, 30);

        jTextField10.setEditable(false);
        getContentPane().add(jTextField10);
        jTextField10.setBounds(380, 120, 130, 30);
        ...
        CampoFecha1.setBounds(1140, 150, 50, 30);
 ...
 this.Guardar.setEnabled(true);       
  this.BotonEliminardetalle.setEnabled(true);
    ...
    private void jButton3FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jButton3FocusGained
       this.jTextField8.setText(VBuscaCliente.Id);
        this.jTextField9.setText(VBuscaCliente.Cliente);
        this.jTextField10.setText(VBuscaCliente.Id1);
        // TODO add your handling code here:
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
     Id=this.CampoCodigo.getText();
        ...
        new cFormaPago1(new vFormaPago1()).iniciar();
		}
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cFacturaVenta1(new vFacturaVenta1()).iniciar();
            }
        });
    }

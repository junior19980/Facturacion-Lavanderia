package vista;
import controlador.*;
public class VBuscaFacturaVenta extends javax.swing.JFrame {
 static String Id= "";
 static String Cliente= "";
  static String Id1= "";
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1250, 430));
        ...
        jScrollPane1.setBounds(10, 50, 1210, 160);

        CampoBuscar.setFont(new java.awt.Font("Purisa", 1, 18)); // NOI18N
        jPanel1.add(CampoBuscar);
        CampoBuscar.setBounds(1030, 10, 190, 40);

        jLabel2.setFont(new java.awt.Font("Purisa", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Buscar ");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(950, 10, 80, 40);
        ...
        Seleccionar.setBounds(1080, 220, 130, 40);
        ...
        CampoDescripcion1.setEditable(false);
        CampoDescripcion1.setFont(new java.awt.Font("Purisa", 1, 14)); // NOI18N
        jPanel1.add(CampoDescripcion1);
        CampoDescripcion1.setBounds(180, 20, 130, 30);

        jTabbedPane1.addTab("Listado", jPanel1);

        getContentPane().add(jTabbedPane1);
        jTabbedPane1.setBounds(0, 50, 1230, 310);

        jLabel1.setFont(new java.awt.Font("Purisa", 1, 18)); // NOI18N
        jLabel1.setText("Facturas Ventas");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(540, 20, 210, 30);
    ...
    private void SeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SeleccionarActionPerformed
        ...
        Id1= this.CampoDescripcion1.getText();
        dispose();

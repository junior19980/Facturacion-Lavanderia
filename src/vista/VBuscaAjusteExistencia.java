...
package vista;
import controlador.*;
public class VBuscaAjusteExistencia extends javax.swing.JFrame {
 static String Id= "";
 ...
 static String Cliente1= "";
    ...
    private void initComponents() {
        ...
        Seleccionar.setBounds(1060, 370, 140, 50);
        ...
        jLabel1.setText("Nota Credito Compra");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(500, 30, 220, 30);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
             new CBuscaAjusteExistencia (new VBuscaAjusteExistencia()).iniciar();            
            }
        });
    }

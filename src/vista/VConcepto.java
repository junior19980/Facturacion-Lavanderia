...
public class VConcepto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(10, 40, 1170, 150);
        jPanel1.add(CampoBuscar);
        CampoBuscar.setBounds(990, 10, 190, 30);

        jLabel2.setFont(new java.awt.Font("Purisa", 3, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Buscar ");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(930, 10, 60, 30);
        ...
        Seleccionar.setBounds(1060, 190, 120, 30);
        ...
        CampoCodigo.setBounds(400, 50, 70, 30);

        CampoDescripcion.setFont(new java.awt.Font("Purisa", 0, 14)); // NOI18N
        jPanel2.add(CampoDescripcion);
        CampoDescripcion.setBounds(570, 50, 130, 30);

        jLabel3.setFont(new java.awt.Font("Purisa", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Codigo");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(330, 50, 70, 30);

        jLabel4.setFont(new java.awt.Font("Purisa", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Descripcion");
        jPanel2.add(jLabel4);
        jLabel4.setBounds(480, 50, 90, 30);

        Modificar.setFont(new java.awt.Font("Purisa", 0, 14)); // NOI18N
        ...
        Modificar.setBounds(560, 110, 110, 40);

        Informe.setFont(new java.awt.Font("Purisa", 0, 14)); // NOI18N
        Informe.setText("Informe");
        jPanel2.add(Informe);
        Informe.setBounds(700, 170, 100, 40);

        Eliminar.setFont(new java.awt.Font("Purisa", 0, 14)); // NOI18N
        ...
        Eliminar.setBounds(700, 110, 100, 40);

        Cancelar.setFont(new java.awt.Font("Purisa", 0, 14)); // NOI18N
        ...
        Cancelar.setBounds(560, 170, 110, 40);

        Guardar.setFont(new java.awt.Font("Purisa", 0, 14)); // NOI18N
        Guardar.setText("Guardar");
        jPanel2.add(Guardar);
        Guardar.setBounds(430, 110, 100, 40);

        Nuevo.setFont(new java.awt.Font("Purisa", 0, 14)); // NOI18N
        Nuevo.setText("Nuevo");
        ...
        jPanel2.add(Nuevo);
        Nuevo.setBounds(430, 170, 100, 40);

        jLabel5.setFont(new java.awt.Font("Purisa", 0, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Precio");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(710, 50, 60, 30);

        CampoDescripcion1.setFont(new java.awt.Font("Purisa", 0, 14)); // NOI18N
        jPanel2.add(CampoDescripcion1);
        CampoDescripcion1.setBounds(770, 50, 130, 30);

        jTabbedPane1.addTab("Registro", jPanel2);

        getContentPane().add(jTabbedPane1);
        jTabbedPane1.setBounds(0, 50, 1210, 280);
        ...
        Salir.setBounds(1100, 340, 90, 30);

...
import controlador.*;
import vista.*;
public class vServicioRealizado extends javax.swing.JFrame {
   static String Id= "";
    /**
     * Creates new form VProducto
     */
    public vServicioRealizado() {
        initComponents(); 
    }
   // mRecepcionPrenda modelo = new mRecepcionPrenda();
    ...
    private void initComponents() {
        ...
        Cancelar.setBounds(230, 540, 190, 40);
        ...
        Guardar.setBounds(650, 540, 170, 40);
        ...
        Nuevo.setBounds(450, 540, 170, 40);
        ...
        jLabel2.setBounds(290, 10, 340, 30);
        ...
        CODSERVICIO.setBounds(80, 50, 90, 40);
        ...
        jScrollPane1.setBounds(10, 90, 830, 160);
        ...
        BotonAgregardetalle.setBounds(700, 50, 140, 40);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("                           DETALLES DE SERVICIO REALIZADO");
        jPanel3.add(jLabel1);
        jLabel1.setBounds(30, 0, 730, 30);

        SERVICIO.setEditable(false);
        jPanel3.add(SERVICIO);
        SERVICIO.setBounds(260, 50, 300, 40);

        jLabel15.setFont(new java.awt.Font("Purisa", 1, 12)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("  Codigo");
        jPanel3.add(jLabel15);
        jLabel15.setBounds(20, 50, 60, 40);

        CANTIDAD.setEditable(false);
        jPanel3.add(CANTIDAD);
        CANTIDAD.setBounds(630, 50, 70, 40);
        ...
        jLabel18.setBounds(570, 50, 80, 40);

        getContentPane().add(jPanel3);
        jPanel3.setBounds(10, 200, 860, 270);
        ...
        CampoCodigoUsu.setBounds(640, 60, 50, 30);
        ...
        CampoCodigo2.setBounds(690, 60, 140, 30);
        ...
        jLabel22.setBounds(590, 60, 50, 30);
        ...
        Seleccionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen2/buscando.png"))); // NOI18N
        Seleccionar.setText("Orden de servicio");
        ...
        jLabel8.setBounds(490, 120, 100, 40);

        jLabel9.setFont(new java.awt.Font("Purisa", 1, 10)); // NOI18N
        jLabel9.setText("Cliente");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(280, 120, 100, 40);
...
// TODO add your handling code here:
    ...
    private void SeleccionarFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_SeleccionarFocusGained
        ...
        this.CODSERVICIO.setText(VBuscaOrdenTrabajo.Cliente);
        this.SERVICIO.setText(VBuscaOrdenTrabajo.Cliente1);
//        this.PRECIO.setText(VBuscaDiagnostico.Cliente3);
        this.CANTIDAD.setText(VBuscaOrdenTrabajo.Cliente2);
          this.CampoCod.setText(VBuscaOrdenTrabajo.Id);
        this.Cliente.setText(VBuscaOrdenTrabajo.Cliente5);   
        this.ci.setText(VBuscaOrdenTrabajo.Cliente6);
    }//GEN-LAST:event_SeleccionarFocusGained

    private void SeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SeleccionarActionPerformed
        // TODO add your handling code here:
         new CBuscaOrdenTrabajo(new VBuscaOrdenTrabajo()).iniciar();

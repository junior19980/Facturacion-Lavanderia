package vista;
import controlador.*;
public class VBuscaCuentaCobrar extends javax.swing.JFrame {
...
public  static String Id1= "";
 static String Cliente1= "";
    ...
    private void initComponents() {
        ...
        CampoDescripcion.setFont(new java.awt.Font("Purisa", 1, 18)); // NOI18N
        jPanel1.add(CampoDescripcion);
        CampoDescripcion.setBounds(50, 11, 90, 40);

        telefono2.setEditable(false);
        telefono2.setFont(new java.awt.Font("Purisa", 1, 18)); // NOI18N
        jPanel1.add(telefono2);
        telefono2.setBounds(140, 10, 130, 40);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
             new CBuscaCuentaCobrar(new VBuscaCuentaCobrar()).iniciar();            }
        });
    }

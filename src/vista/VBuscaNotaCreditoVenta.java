...
public class VBuscaNotaCreditoVenta extends javax.swing.JFrame {
 static String Id= "";
 ...
 static String Cliente1= "";
    ...
    private void initComponents() {
        ...
        Seleccionar1.setBounds(900, 370, 160, 50);
        ...
        jLabel1.setText("Nota Credito Venta");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(500, 20, 200, 30);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
             new CBuscaNotaCreditoVenta(new VBuscaNotaCreditoVenta()).iniciar();            }
        });
    }

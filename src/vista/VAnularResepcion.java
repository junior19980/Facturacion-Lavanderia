...
import controlador.CAnularResepcion;
/**
 *
 * @author Sammy Guergachi <sguergachi at gmail.com>
 */
public class VAnularResepcion extends javax.swing.JFrame {
 static String Id= "";
 ...
 static String ciudad="";
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Pin");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(590, 130, 50, 30);
        ...
        CampoDescripcion5.setBounds(640, 130, 80, 30);
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAnularResepcion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
 new CAnularResepcion(new VAnularResepcion()).iniciar();   }
        });
    }

package vista;
import controlador.*;
public class VBuscaServicioRealizado extends javax.swing.JFrame {
 static String Id= "";
 ...
 static String Cliente1= "";
     ...
     */
    public VBuscaServicioRealizado() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(778, 457));
        ...
        jScrollPane1.setBounds(10, 50, 700, 200);

        CampoBuscar.setFont(new java.awt.Font("Purisa", 0, 10)); // NOI18N
        jPanel1.add(CampoBuscar);
        CampoBuscar.setBounds(450, 10, 190, 40);

        jLabel2.setFont(new java.awt.Font("Purisa", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Buscar ");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(390, 0, 60, 40);

        Seleccionar.setFont(new java.awt.Font("Purisa", 0, 18)); // NOI18N
        ...
        Seleccionar.setBounds(580, 250, 120, 50);

        CampoCodigo.setEditable(false);
        CampoCodigo.setFont(new java.awt.Font("Purisa", 0, 11)); // NOI18N
        jPanel1.add(CampoCodigo);
        CampoCodigo.setBounds(10, 20, 40, 30);

        CampoDescripcion.setEditable(false);
        CampoDescripcion.setFont(new java.awt.Font("Purisa", 0, 11)); // NOI18N
        jPanel1.add(CampoDescripcion);
        CampoDescripcion.setBounds(50, 20, 90, 30);

        telefono2.setEditable(false);
        telefono2.setFont(new java.awt.Font("Purisa", 0, 11)); // NOI18N
        jPanel1.add(telefono2);
        telefono2.setBounds(140, 20, 130, 30);

        Seleccionar1.setFont(new java.awt.Font("Purisa", 0, 18)); // NOI18N
        ...
        Seleccionar1.setBounds(400, 250, 140, 50);

        jTabbedPane1.addTab("Listado", jPanel1);

        getContentPane().add(jTabbedPane1);
        jTabbedPane1.setBounds(0, 50, 740, 350);

        jLabel1.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel1.setText("Servicios Realizados");

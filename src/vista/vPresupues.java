...
import controlador.*;
import vista.*;
public class vPresupues extends javax.swing.JFrame {
   static String Id= "";
    /**
   ...
   // mRecepcionPrenda modelo = new mRecepcionPrenda();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Formulario Presupuesto");
        ...
        CODSERVICIO.setBounds(50, 50, 90, 40);
        ...
        jLabel1.setText("                           DETALLES DE PRESUPUESTO");
        jPanel3.add(jLabel1);
        ...
        jLabel17.setBounds(150, 50, 80, 40);
        ...
        CampoCodigoUsu.setBounds(750, 60, 50, 30);
        ...
        CampoCodigo2.setBounds(800, 60, 140, 30);
        ...
        jLabel22.setBounds(700, 60, 50, 30);
        ...
        Seleccionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen2/buscar.png"))); // NOI18N
        Seleccionar.setText("Solicitud Servicio");

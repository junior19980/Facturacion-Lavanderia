...
public class VBuscaServicioRalizadoF extends javax.swing.JFrame {
     ...
     */
    public VBuscaServicioRalizadoF() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(cliente);
        cliente.setBounds(610, 20, 110, 30);

        ci.setEditable(false);
        jPanel1.add(ci);
        ci.setBounds(720, 20, 110, 30);

        idcliente.setEditable(false);
        jPanel1.add(idcliente);
        idcliente.setBounds(570, 20, 40, 30);
        ...
        jLabel1.setText("Listados de Servicio Realizado");

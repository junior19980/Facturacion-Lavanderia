...
public class VBuscaOrdenTrabajo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(cliente);
        cliente.setBounds(570, 20, 170, 30);

        ci.setEditable(false);
        jPanel1.add(ci);
        ci.setBounds(740, 20, 150, 30);
        ...
        jLabel1.setText("Listados de Orden de Trabajo");

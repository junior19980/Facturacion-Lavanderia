...
import controlador.CColorVehiculo;

public class VColorVehiculo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(20, 60, 1170, 430);
        ...
        Seleccionar.setBounds(1070, 490, 120, 30);
        ...
        CampoCodigo.setBounds(470, 170, 70, 30);
        jPanel2.add(CampoDescripcion);
        CampoDescripcion.setBounds(700, 170, 130, 30);

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Codigo");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(400, 170, 70, 30);

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Descripcion");
        jPanel2.add(jLabel4);
        jLabel4.setBounds(610, 170, 90, 30);
        ...
        Eliminar.setBounds(700, 270, 100, 40);
        ...
        Cancelar.setBounds(560, 330, 100, 40);

        Guardar.setFont(new java.awt.Font("Times New Roman", 1, 10)); // NOI18N
        Guardar.setText("Guardar");
        jPanel2.add(Guardar);
        Guardar.setBounds(430, 270, 100, 40);
        ...
        jPanel2.add(Nuevo);
        Nuevo.setBounds(430, 330, 100, 40);

        jTabbedPane1.addTab("Registro", jPanel2);

        getContentPane().add(jTabbedPane1);
        jTabbedPane1.setBounds(0, 50, 1210, 570);

        jLabel1.setFont(new java.awt.Font("Purisa", 3, 18)); // NOI18N
        jLabel1.setText("Color del Vehiculo");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(480, 20, 260, 30);
        ...
        Salir.setBounds(1100, 620, 90, 40);
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VColorVehiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
import modelo.*;
import controlador.*;
public class vCalculaIvaVenta extends javax.swing.JFrame {
   static String Id= "";
    /**
     * Creates new form VProducto
     */
    public vCalculaIvaVenta() {
        initComponents(); 
    }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cCalculaIvaVenta(new vCalculaIvaVenta()).iniciar();
            }
        });
    }

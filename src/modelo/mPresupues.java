...
public class mPresupues extends ConexionBD {
    public ResultSet rs;
  //  vRecepcion Vista;
...
//Factura Ventas Tabla Principal
    ...
    public boolean RegistrarVenta( String Codigo,String nro_factura, String idProveedor, String fecha  ) {
        try {
            String q =  " insert into presupuestosservicios(idPresupuestoServicio,idUsuario,Fecha,idSolicitudCliente)"
                    + "values('" + Codigo + "', '" + nro_factura + "', '" + idProveedor + "','" + fecha +"')";
...
//Detalle tabla secundario//
    ...
    public boolean RegistrarDetalleVenta(String Codigo, String idaccesorio, String dia,String asdfklj ) {
        try {
            String q2 =" insert into detallespresupuestosclientes(idPresupuestoServicio,idServicio,Cantidad ,Precio)"
                   + "values('" + Codigo + "','" + idaccesorio + "','" + dia + "','" + asdfklj + "' )";
    ...
    public void generar_codigo() {
        try {
            ...
            Logger.getLogger(mPresupues.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
//Combo 1 Cliente

...
public class MBuscaMotivoAjuste extends ConexionBD {
...
public MBuscaMotivoAjuste() {
    ...
    public DefaultTableModel getTablaBusqueda() {
      ...
      //obtenemos la cantidad de registros existentes en la tabla y se almacena en la variable "registros"
        ...
        try {
            PreparedStatement pstm = this.getConnection().prepareStatement("SELECT count(*) as total FROM MotivosAjustes WHERE idMotivoAjuste LIKE '%" + filtro + "%' ");
        ...
        try {
            ...
            PreparedStatement pstm = this.getConnection().prepareStatement("SELECT * FROM MotivosAjustes  WHERE idMotivoAjuste LIKE '%" + filtro + "%' ORDER BY idMotivoAjuste");
            ResultSet res = pstm.executeQuery();
            int i = 0;
            while (res.next()) {

...
public class MBuscaProveedor extends ConexionBD {
...
public MBuscaProveedor() {
    ...
    public DefaultTableModel getTablaBusqueda() {
      ...
      //obtenemos la cantidad de registros existentes en la tabla y se almacena en la variable "registros"
        ...
        try {
            PreparedStatement pstm = this.getConnection().prepareStatement("SELECT count(*) as total FROM Proveedores WHERE idProveedor LIKE '%" + filtro + "%' ");
        ...
        try {
            ...
            PreparedStatement pstm = this.getConnection().prepareStatement("SELECT * FROM Proveedores  WHERE idProveedor LIKE '%" + filtro + "%' ORDER BY idProveedor");
            ResultSet res = pstm.executeQuery();
            int i = 0;
            while (res.next()) {

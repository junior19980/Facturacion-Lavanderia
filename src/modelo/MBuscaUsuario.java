...
public class MBuscaUsuario extends ConexionBD {
    ...
    public DefaultTableModel getTablaBusqueda() {
        ...
        int registros = 0;
        String[] columNames = {"Codigo", "Nombre Usuario", "Nivel Acceso"};
      //obtenemos la cantidad de registros existentes en la tabla y se almacena en la variable "registros"
        ...
        try {
            ...
            while (res.next()) {
                ...
                data[i][2] = res.getString("nivelAcceso");
                i++;
            }
            res.close();

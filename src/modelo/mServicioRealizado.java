...
public class mServicioRealizado extends ConexionBD {
    public ResultSet rs;
  //  vRecepcion Vista;
...
//Factura Ventas Tabla Principal
    ...
    public boolean RegistrarVenta( String Codigo,String fecha, String orden, String usu  ) {
        try {
            String q =  " insert into serviciosrealizados(idServicioRealizado,Fecha,idOrdenTrabajo,idUsuario)"
                    + "values('" + Codigo + "', '" + fecha + "', '" + orden + "', '" + usu + "')";
...
//Detalle tabla secundario//
    ...
    public boolean RegistrarDetalleVenta(String Codigo, String idaccesorio, String dia) {
        try {
            String q2 =" insert into detallesserviciosrealizados(idServicioRealizado,idServicio,Cantidad )"
    ...
    public void generar_codigo() {
        try {
            PreparedStatement pstm2 = this.getConnection().prepareStatement("select MAX(idServicioRealizado) + 1 as nro from serviciosrealizados");
            ...
            Logger.getLogger(mServicioRealizado.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
//Combo 1 Cliente
...
//Carga datos//
    ...
    //Reporte
    public void Reportes(String archivo, JTable tabla, String Nro, String USU, String Apellidofun,String CI) {
        try {

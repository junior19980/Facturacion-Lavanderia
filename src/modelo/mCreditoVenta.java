...
public class mCreditoVenta extends ConexionBD {
...
//Factura Ventas Tabla Principal
    ...
    public boolean RegistrarVenta( String Fecha, String idUsuarios, String idEquipo, String Dsa,String sdf,String total,String iva) {
        try {
            String q =  " insert into NotasCreditosServicios(idNotaCreditoServicio,numero,fecha,idUsuario,idTimbrado,idFacturaServicio,total,iva)"
                    + "values('" + Nro_Factura + "', '" + Fecha + "', '" + idUsuarios + "', '" + idEquipo + "','" + Dsa +"','" + sdf +"','" + total +"','" + iva +"')";
...
//Detalle tabla secundario//
    ...
    public boolean RegistrarDetalleVenta(String idaccesorio, String dia,String asdfklj) {
        try {
            String q2 =" insert into DetallesCreditosServicios(idNotaCreditoServicio,idServicio,precio,cantidad)"
                   + "values('" + Nro_Factura + "','" + idaccesorio + "','" + dia + "','" + asdfklj + "' )";
    ...
    public void generar_codigo() {
        try {
            PreparedStatement pstm2 = this.getConnection().prepareStatement("select MAX(idNotaCreditoServicio) + 1 as nro from NotasCreditosServicios");
            ...
            Logger.getLogger(mCreditoVenta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

...
public class mSolicitudServicio extends ConexionBD {
    public ResultSet rs;
    vResepcion Vista;
...
//Factura Ventas Tabla Principal
    ...
    public boolean RegistrarVenta( String Codigo,String Fecha, String obs, String idusu, String idCliente) {
        try {
            String q =  " insert into solicitudesclientes(idSolicitudCliente,Fecha,Observacion, idUsuario, idCliente)"
...
//Detalle tabla secundario//
    ...
    public boolean RegistrarDetalleVenta(String idaccesorio, String Cantidad ) {
        try {
            String q2 =" insert into detallessolicitudesclientes(idSolicitudCliente,idServicio, Cantidad )"
    ...
    public void generar_codigo() {
        try {
            PreparedStatement pstm2 = this.getConnection().prepareStatement("select MAX(idSolicitudCliente) + 1 as nro from solicitudesclientes");
            ...
            Logger.getLogger(mSolicitudServicio.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
//Combo 1 Cliente

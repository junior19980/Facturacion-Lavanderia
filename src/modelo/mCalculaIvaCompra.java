...
//Factura Ventas Tabla Principal
    ...
    public boolean RegistrarVenta( String Codigo) {
        try {
            String q = "SELECT SUM(f.iva)'IVA' FROM FacturasCompras f WHERE f.mes='"+Codigo+"'";
           ...
           String w = "SELECT SUM(f.iva)'IVA' FROM NotasCreditosCompras f WHERE f.mes='"+Codigo+"'";
           ...
           String e = "SELECT SUM(f.iva)'IVA' FROM NotasDebitosCompras f WHERE f.mes='"+Codigo+"'";
...
//Detalle tabla secundario//
    ...
    public void generar_codigo() {
        try {
            ...
            Logger.getLogger(mCalculaIvaCompra.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

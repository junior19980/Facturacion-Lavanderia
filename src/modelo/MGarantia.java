...
public class MGarantia extends ConexionBD {
...
//Factura Ventas Tabla Principal
    ...
    public boolean RegistrarVenta(String Fecha,String fechaVe, String idEquipo,String obse,String idUsuario) {
        try {
            String q = " insert into Garantias (idGarantia,fecha,fechaVencimiento,idServicioRealizado,idUsuario,observacion)"
                    + "values( '" + Nro_Factura + "', '" + Fecha + "', '" + fechaVe + "',   '" + idEquipo + "',  '" + obse + "',  '" + idUsuario + "');";
...
//Detalle tabla secundario//
    ...
    public void generar_codigo() {
        try {
            PreparedStatement pstm2 = this.getConnection().prepareStatement("select MAX(idGarantia) + 1 as nro from Garantias");
            ...
            Logger.getLogger(MGarantia.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
//Combo 1 Cliente
...
//Carga datos//
    public boolean cargarDatos(String codigo, String servicio, JTable tabla) {
  ...
  // //     int cantidad2 = Integer.parseInt(cantidad);
    ...
    //    total = String.valueOf(total2);
        ...
        tableModel.addRow(new Object[]{codigo, servicio});

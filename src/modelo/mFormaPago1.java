...
public class mFormaPago1 extends ConexionBD {
...
//Factura Ventas Tabla Principal
    ...
    public boolean RegistrarVenta( String Codigo,String Fecha, String idUsuarios, String idEquipo, String idCliente, String fdasf,String sldf,String kfd) {
        try {
String q =  " insert into Cobros(idCobro,fecha,Descripcion, idAperturaCaja,idUsuario,idFacturaServicio,monto)"
			+ "values('" + Nro_Factura + "', '" + Fecha + "', '" + idUsuarios + "', '" + idEquipo + "','" + idCliente +"', '" + fdasf + "', '" + sldf + "')";
...
//Detalle tabla secundario/
    public void generar_codigo() {
        try {
            ...
            Logger.getLogger(mFormaPago1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
//Combo 1 Cliente

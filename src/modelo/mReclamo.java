...
public class mReclamo extends ConexionBD {
    public ResultSet rs;
    vResepcion vista;
...
//Factura Ventas Tabla Principal
    ...
    public boolean RegistrarVenta( String Codigo,String Fecha, String idUsuarios, String idEquipo, String idCliente) {
        try {
            String q =  " insert into Reclamos(idReclamo,fecha,Observacion, idCliente, idUsuario)"
...
//Detalle tabla secundario/
    public void generar_codigo() {
        try {
            PreparedStatement pstm2 = this.getConnection().prepareStatement("select MAX(idReclamo) + 1 as nro from Reclamos");
            ...
            Logger.getLogger(mReclamo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
//Combo 1 Cliente

...
public class mNotaDebitoCompra extends ConexionBD {

    public ResultSet rs;
    //   vNotaDebitoCompra vista;
    public int totales3 = 0;
    public int iva = 0;
    public String Nro_Factura = "";
//Factura Ventas Tabla Principal

    public boolean RegistrarVenta(String Codigo, String Fecha, String total, String fac, String usu, String nro, String iva, String fwch, String mes, String Timbrado) {
        try {
            String q = " insert into NotasDebitosCompras(idNotaDebitoCompra,fecha,total,idUsuario,idFacturaCompra,nroDebito, iva, FechaDocumento, mes,Timbrado)"
                    + "values('" + Codigo + "', '" + Fecha + "', '" + total + "','" + fac + "','" + usu + "','" + nro + "','" + iva + "','" + fwch + "','" + mes + "','" + Timbrado + "')";
...
//Detalle tabla secundario//
    ...
    public boolean RegistrarDetalleVenta(String Codigo, String idaccesorio, String dia, String dñflakjsd) {
        try {
            String q2 = " insert into DetallesDebitoCompras(idNotaDebitoCompra,idConcepto,precio,cantidad)"
    ...
    public void generar_codigo() {
        try {
            PreparedStatement pstm2 = this.getConnection().prepareStatement("select MAX(idNotaDebitoCompra) + 1 as nro from NotasDebitosCompras");
            ...
            Logger.getLogger(mNotaDebitoCompra.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
//Combo 1 Cliente

...
public class mCuentaCobrar extends ConexionBD {
    public ResultSet rs;
       public ResultSet r;
    vResepcion Vista;
...
//Factura Ventas Tabla Principal
    ...
    public boolean RegistrarVenta(String Fecha, String idUsuarios, String idEquipo, String idCliente) {
        try {
            String q =    " insert into CuentasCobrar(idCuentaCobrar,idFacturaServicio,monto,idInteres,fecha,idUsuario)"
                    + "values('" + Nrocuenta + "', '" + NroFactura + "', '" + Fecha + "', '" + idUsuarios + "', '" + idEquipo + "','" + idCliente +"')";
...
//Detalle tabla secundario/
         public void genera() {
        try {
            PreparedStatement pstm2 = this.getConnection().prepareStatement("select MAX(idCuentaCobrar) + 1 as nro from CuentasCobrar");
            ...
            Logger.getLogger(mCuentaCobrar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

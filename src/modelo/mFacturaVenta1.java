...
public class mFacturaVenta1 extends ConexionBD {
...
//Factura Ventas Tabla Principal
    ...
    public boolean RegistrarVenta( String Codigo,String Fecha, String idUsuarios, String idEquipo, String idCliente,String Dsa,String sdf,String sddfa,String Factura,String mes,String iva) {
        try {
            String q =  " insert into FacturasServicios(idFacturaServicio,Factura,fecha,total,idCliente,idUsuario,idAperturaCaja,idTimbrado,idTipoFactura,mes,iva)"
                    + "values('" + Nro_Factura + "', '" + Fecha + "', '" + idUsuarios + "', '" + idEquipo + "','" + idCliente +"','" + Dsa +"','" + sdf +"','" + sddfa +"','" + Factura +"','" + mes +"','" + iva +"')";
...
//Detalle tabla secundario//
    ...
    public boolean RegistrarDetalleVenta(String idaccesorio, String dia,String asdfklj,String lkdsajf) {
        try {
            String q2 =" insert into DetallesFacturasServicios(idFacturaServicio,idServicio,precio,cantidad)"

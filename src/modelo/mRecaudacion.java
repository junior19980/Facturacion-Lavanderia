...
public class mRecaudacion extends ConexionBD {
    public ResultSet rs;
    vResepcion Vista;
...
//Factura Ventas Tabla Principal
    ...
    public boolean RegistrarVenta( String Codigo,String Fecha, String idUsuarios, String idEquipo, String idCliente) {
        try {
            String q =  " insert into recaudaciones(idRecaudacion,Monto,idArqueoCajas, idUsuarios, idAperturaCaja)"
...
//Detalle tabla secundario/
    public void generar_codigo() {
        try {
            PreparedStatement pstm2 = this.getConnection().prepareStatement("select MAX(idRecaudacion) + 1 as nro from recaudaciones");
            ...
            Logger.getLogger(mRecaudacion.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
//Combo 1 Cliente

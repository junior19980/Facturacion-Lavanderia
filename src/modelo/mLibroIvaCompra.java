...
public class mLibroIvaCompra extends ConexionBD {
    public ResultSet rs;
       public ResultSet r;
    vResepcion Vista;
...
//Factura Ventas Tabla Principal
    public boolean RegistrarVenta(String Codigo,  String gravada10, String idUsuarios, String idEquipo, String idCliente, String hola, String id) {
        try {
            String q =    " insert into LibrosIvasCompras(idLibroIva, grabada10, grabada5, Exenta, iva10, iva5, idFacturaCompra)"
...
//Detalle tabla secundario/
     ...
     public void genera() {
        try {
            PreparedStatement pstm2 = this.getConnection().prepareStatement("select MAX(idLibroIva) + 1 as nro from LibrosIvasCompras");
            ...
            Logger.getLogger(mLibroIvaCompra.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    /*  public void generar_codigo() {
        try {
            PreparedStatement pstm = this.getConnection().prepareStatement("select MAX(NroFacturaCompra) as nro from facturacompras");

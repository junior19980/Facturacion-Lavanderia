...
public class mOrdenCompra extends ConexionBD {
    public ResultSet rs;
    vResepcion Vista;
...
//Factura Ventas Tabla Principal
    ...
    public boolean Registrar( String Codigo,String Fecha, String idUsuarios, String idEquipo) {
        try {
            String q =  " insert into OrdenesCompras(idOrdenCompra,fecha,idUsuario,idProveedor)"
...
//Detalle tabla secundario//
    public boolean RegistrarDetalle(String idaccesorio,String idorden, String Canti) {
        try {
            String q2 =" insert into DetallesOrdenesCompras(idInsumo,idOrdenCompra,Cantidad)"
                   + "values('" + idaccesorio + "', '" + idorden + "','" + Canti + "')";
    ...
    public void generar_codigo() {
        try {
            PreparedStatement pstm2 = this.getConnection().prepareStatement("select MAX(idOrdenCompra) + 1 as nro from OrdenesCompras");
            ...
            Logger.getLogger(mOrdenCompra.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
//Combo 1 Cliente
...
//Carga datos//
  ...
  // //     int cantidad2 = Integer.parseInt(cantidad);
    ...
    //    total = String.valueOf(total2);
        ...
        tableModel.addRow(new Object[]{codigo, servicio, Precio, cantidad});
  //      int totales2 = Integer.parseInt(totales);
   //     totales3 = total2 + totales2;
    ...
    //Reporte
    public void Reportes(String archivo, JTable tabla, String Nro, String Fecha, String Nombrefun , String Apellidofun,String Total, String dffhsf ) {
        try {
            ...
            parametros.put("idProv", Apellidofun);
            parametros.put("nomProv", Total);
            parametros.put("rucProv",dffhsf );
           // parametros.put("idSucu", refdg);
         //   parametros.put("nomSucu", dfgcr);

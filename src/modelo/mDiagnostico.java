...
public class mDiagnostico extends ConexionBD {
    public ResultSet rs;
    vResepcion Vista;
...
//Factura Ventas Tabla Principal
    ...
    public boolean RegistrarVenta( String Codigo,String Fecha, String obs, String idusu, String idCliente) {
        try {
            String q =  " insert into diagnosticos(idDiagnostico,Fecha,Observacion, idUsuario, idRecepcion)"
...
//Detalle tabla secundario//
    ...
    public boolean RegistrarDetalleVenta(String idaccesorio, String Cantidad ) {
        try {
            String q2 =" insert into detallesdiagnosticos(idDiagnostico,idServicio, Cantidad )"
    ...
    public void generar_codigo() {
        try {
            PreparedStatement pstm2 = this.getConnection().prepareStatement("select MAX(idDiagnostico) + 1 as nro from diagnosticos");
            ...
            Logger.getLogger(mDiagnostico.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
//Combo 1 Cliente

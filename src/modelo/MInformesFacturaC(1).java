...
public class MInformesFacturaC extends ConexionBD{
     public ResultSet rs;
     public String idBarrios = "";
      public String filtro = "";
    /** Constructor de clase */
    public MInformesFacturaC (){}

    // PARA LA BUSQUEDA EL FILTRO
 
     public void Reportespc(String archivo) throws SQLException {
        try {
            PreparedStatement psta = this.getConnection().prepareStatement("select * FROM vpc");
            ...
            Logger.getLogger(MInformesFacturaC.class.getName()).log(Level.SEVERE, null, ex);
        } 
 ...
 public void Reportesoc(String archivo) throws SQLException {
        try {
            PreparedStatement psta = this.getConnection().prepareStatement("select * FROM vpedidoorden");
            ResultSet rss = psta.executeQuery();
            //Pasamos parametros para el Jasper
            JRResultSetDataSource jRs = new JRResultSetDataSource(rss);
            Map parametros = new HashMap();
     ...
     public void Reportespp(String archivo) throws SQLException {
        try {
            PreparedStatement psta = this.getConnection().prepareStatement("select * FROM facturascompras");
            ResultSet rss = psta.executeQuery();
            //Pasamos parametros para el Jasper
            JRResultSetDataSource jRs = new JRResultSetDataSource(rss);
            Map parametros = new HashMap();
  ...
  public void Reportesnc(String archivo) throws SQLException {
        try {
            PreparedStatement psta = this.getConnection().prepareStatement("select * FROM notascreditoscompras");
            ResultSet rss = psta.executeQuery();
            //Pasamos parametros para el Jasper
            JRResultSetDataSource jRs = new JRResultSetDataSource(rss);
            Map parametros = new HashMap();
  ...
  public void Reportesnd(String archivo) throws SQLException {
        try {
            PreparedStatement psta = this.getConnection().prepareStatement("select * FROM notasdebitoscompras");
            ResultSet rss = psta.executeQuery();
            //Pasamos parametros para el Jasper
            JRResultSetDataSource jRs = new JRResultSetDataSource(rss);
            Map parametros = new HashMap();

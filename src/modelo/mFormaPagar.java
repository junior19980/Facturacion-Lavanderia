...
public class mFormaPagar extends ConexionBD {
...
//Factura Ventas Tabla Principal
    ...
    public boolean RegistrarVenta( String Codigo,String Fecha, String idUsuarios,  String idCliente, String fdasf,String sldf,String kfd) {
        try {
String q =  " insert into Pagos(idPago,fecha,Descripcion,idUsuario,idFacturacompra,monto)"
			+ "values('" + Nro_Factura + "', '" + Fecha + "', '" + idUsuarios + "', '"  + idCliente +"', '" + fdasf + "', '" + sldf + "')";
...
//Detalle tabla secundario/
    public void generar_codigo() {
        try {
            ...
            Logger.getLogger(mFormaPagar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
//Combo 1 Cliente

...
public class cEntrega implements ActionListener {
    vEntrega  Vista;
    mEntrega  Modelo = new mEntrega ();
Macceso modelo = new Macceso();
    ...
    public cEntrega(vEntrega  Vista) {
        this.Vista = Vista;
    }
    public void iniciar() {
        ...
        this.Vista.Nuevo.setEnabled(true);
         /**this.Vista.SeleccionarServicio.setEnabled(false);
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cEntrega.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
...
//                this.Vista.BotonAgregardetalle.setEnabled(true);
               ...
               JTable tabla3 = this.Vista.TablaDetalle;
                if (this.Modelo.RegistrarVenta(
                      this.Vista.CampoCodigo.getText(),
                        ...
                        this.Vista.CodRecepcion.getText(),
                    ...
                    for (int i = 0; i < cantidadMercaderias; i++) {
                        ...
                        String Mercadria = tabla3.getValueAt(i, 2).toString();
                        this.Modelo.RegistrarDetalleVenta(this.Vista.CampoCodigo.getText(), codigoMercadria, Mercadria);
                    }
                
                    JOptionPane.showMessageDialog(Vista, "Exito: Nuevo registro agregado.");
                 this.Modelo.Reportes("Entrega", this.Vista.TablaDetalle, 
                         this.Vista.CampoCodigo.getText(),
            ...
            case SALIR:
             ...
             case AGREGAR_DETALLE:
                ...
                if (this.Modelo.cargarDatos(this.Vista.CODeQUIPO.getText().trim(),this.Vista.Descrp.getText().trim(),this.Vista.Descrp1.getText().trim(), tabla)) {
            ...
            case ELIMINAR_DETALLE:
                ...
                if (indice == -1) {
                    ...
                    String totales = (tabla2.getValueAt(indice, 0).toString());
    ...
    public void limpiarcampos() {
		this.Vista.Descrp.setText("");
                this.Vista.CODeQUIPO.setText("");
        this.Vista.CodRecepcion.setText("");
//        this.Vista.FechaRec.setText("");

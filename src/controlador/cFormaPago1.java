...
public class cFormaPago1 implements ActionListener {
    VAcceso vista;
     VBuscaCuentaCobrar dfd;
    cApertura apertura;
    cFacturaVenta1 venta;
    vFormaPago1 Vista;
    mFormaPago1 Modelo = new mFormaPago1();
Macceso modelo = new Macceso();
    ...
    public cFormaPago1(vFormaPago1 Vista) {
        this.Vista = Vista;
    }
    public void iniciar() {
        this.Vista.jTextField4.setText(String.valueOf(this.venta.total));
	this.Vista.CampoCodigo1.setText(venta.idFactura);
        this.Vista.jTextField1.setText(this.modelo.nivel);
        this.Vista.jTextField2.setText(this.modelo.nombre);
	this.Vista.jTextField3.setText(this.venta.apertura);
        this.Vista.jTextField4.setText(this.venta.apertura);
	//this.Vista.jTextField4.setText(String.valueof(this.venta.total));
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cFormaPago1.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
		this.Vista.CampoCodigo1.setText(venta.idFactura);
        ...
        //this.Vista.jComboBox1.setEnabled(true);
            ...
            case GUARDAR:
             ...
             // String caja[] = this.Vista.jComboBox1.getSelectedItem().toString().split("-");
		...
		if(ban<4){ 
			String codigoMercadria = this.Vista.CampoCodigo.getText();

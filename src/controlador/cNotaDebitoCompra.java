...
public class cNotaDebitoCompra implements ActionListener {

    VAcceso vista;

    vNotaDebitoCompra Vista;
    mNotaDebitoCompra Modelo = new mNotaDebitoCompra();
    ...
    public cNotaDebitoCompra(vNotaDebitoCompra Vista) {
        this.Vista = Vista;
    }
...
//        this.Vista.jButton3.setEnabled(false);
    ...
    public void limpiarcampos() {
      ...
      this.Vista.Timbrado.setText("");
        this.Vista.CampoFechaDocumento.setText("");
        this.Vista.CODSERVICIO.setText("");
        this.Vista.SERVICIO.setText("");
        this.Vista.SeleccionarRecepcion.setEnabled(false);
          this.Vista.CampoTOTAL.setText("0");
            this.Vista.IVA.setText("0");
    }

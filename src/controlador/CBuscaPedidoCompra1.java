...
public class CBuscaPedidoCompra1 implements ActionListener, MouseListener, KeyListener {

        
    /**
     * instancia a nuestra interfaz de usuario
     */
    VBuscaPedidoCompra1 vista;
//    vacceso Vista;
    /**
     * instancia a nuestro modelo
     */
    MBuscaPedidoCompra1 modelo = new MBuscaPedidoCompra1();
     ...
     */
    public CBuscaPedidoCompra1(VBuscaPedidoCompra1 vista) {
        this.vista = vista;
    }
        ...
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.telefono2.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,2)));
                 this.vista.telefono3.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,3)));
                 this.vista.telefono4.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 4)));
                this.vista.telefono5.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 5)));
                this.vista.telefono6.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,6)));
                 this.vista.telefono7.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,7)));
                           }
        }
    }

...
public class cFormaPagoCuentaPagar implements ActionListener {
 VAcceso vista;
 VBuscaCuentaPagar dfd;
 cApertura apertura;
 MenuPrincipal.MenuPrincipalAdmin venta;
    vFormaPagoCuentaPagar Vista;
    mFormaPagoCuentaPagar Modelo = new mFormaPagoCuentaPagar();
Macceso modelo = new Macceso();
    ...
    public cFormaPagoCuentaPagar(vFormaPagoCuentaPagar Vista) {
        this.Vista = Vista;
    }
    public void iniciar() {
	this.Vista.jTextField4.setText(String.valueOf(dfd.Id1));
	//this.Vista.jTextField3.setText(apertura.idApertura);
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cFormaPagoCuentaPagar.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
...
//                        this.Vista.jTextField3.getText(),
		...
		if(ban<4){ String codigoMercadria = this.Vista.CampoCodigo.getText();

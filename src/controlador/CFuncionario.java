...
public class CFuncionario implements ActionListener, MouseListener, KeyListener {
     ...
     */
    MFuncionario modelo = new MFuncionario();
     ...
     */
    public CFuncionario(VFuncionario vista) {
        this.vista = vista;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.codciudad2.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 5)));
                this.vista.descriciudad2.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 6)));
                 this.vista.codciudad3.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 7)));
                this.vista.codciudad4.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,8)));
                this.vista.descriciudad4.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 9)));
                this.vista.codciudad5.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 10)));
                this.vista.descriciudad5.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 11)));
                this.vista.codciudad6.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 12)));
                this.vista.descriciudad6.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 13)));
   ...
   //     this.vista.descriciudad3.setText("");
        ...
        this.vista.descriciudad6.setText("");
        this.vista.codciudad6.setText("");

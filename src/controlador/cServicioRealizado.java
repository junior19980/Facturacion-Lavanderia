...
public class cServicioRealizado implements ActionListener {

    VAcceso vista;
    //public static String basura = "";
    vServicioRealizado Vista;
    mServicioRealizado Modelo = new mServicioRealizado();
    ...
    public cServicioRealizado(vServicioRealizado Vista) {
        this.Vista = Vista;
    }
        ...
        switch (cServicioRealizado.AccionMVC.valueOf(e.getActionCommand())) {
            ...
            case GUARDAR:
                ...
                if (this.Modelo.RegistrarVenta(
                    ...
                    this.Modelo.Reportes("ServiciosRealizados", this.Vista.TablaDetalle,
                            this.Vista.CampoCodigo.getText(),

...
import modelo.MCategoriaInsumo; 
import vista.VCategoriaInsumo; 
import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;

public class CCategoriaProducto implements ActionListener, MouseListener, KeyListener {

    /**
     * instancia a nuestra interfaz de usuario
     */
    VCategoriaInsumo vista;
    /**
     * instancia a nuestro modelo
     */
    MCategoriaInsumo modelo = new MCategoriaInsumo();
     ...
     */
    public CCategoriaProducto(VCategoriaInsumo vista) {
        this.vista = vista;
    }

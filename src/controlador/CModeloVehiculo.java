...
import modelo.MModeloVehiculo; 
import vista.VModeloVehiculo; 
import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;

public class CModeloVehiculo implements ActionListener, MouseListener, KeyListener {

    /**
     * instancia a nuestra interfaz de usuario
     */
    VModeloVehiculo vista;
    /**
     * instancia a nuestro modelo
     */
    MModeloVehiculo modelo = new MModeloVehiculo();
     ...
     */
    public CModeloVehiculo(VModeloVehiculo vista) {
        this.vista = vista;
    }

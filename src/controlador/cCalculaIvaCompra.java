...
public class cCalculaIvaCompra implements ActionListener {
 VAcceso vista;
    public static  String basura="",usu,idFactura="",apertura="";
public static int total;
    vCalculaIvaCompra Vista;
	cApertura med;
    mCalculaIvaCompra Modelo = new mCalculaIvaCompra();
Macceso modelo = new Macceso();
    ...
    public cCalculaIvaCompra(vCalculaIvaCompra Vista) {
        this.Vista = Vista;
    }
    public void iniciar() {
//        basura=this.Vista.CampoCodigo.getText();
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cCalculaIvaCompra.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:

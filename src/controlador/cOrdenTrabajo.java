...
public class cOrdenTrabajo implements ActionListener {

    VAcceso vista;
    //public static String basura = "";
    vOrdenTrabajo Vista;
    mOrdenTrabajo Modelo = new mOrdenTrabajo();
    ...
    public cOrdenTrabajo(vOrdenTrabajo Vista) {
        this.Vista = Vista;
    }
        ...
        switch (cServicioRealizado.AccionMVC.valueOf(e.getActionCommand())) {
            ...
            case GUARDAR:
                ...
                if (this.Modelo.RegistrarVenta(
                        ...
                        this.Vista.CampoCodigoFun.getText(),
                    ...
                    for (int i = 0; i < cantidadMercaderias; i++) {
                        ...
                        this.Modelo.RegistrarDetalleVenta(this.Vista.CampoCodigo.getText(), codigoMercadria, cantidad);
                    }
                    JOptionPane.showMessageDialog(Vista, "Exito: Nuevo registro agregado.");
                    this.Modelo.Reportes("OrdenesTrabajos", this.Vista.TablaDetalle,
                            this.Vista.CampoCodigo.getText(),
                            this.Vista.CampoCodigo2.getText(),
//                            this.Vista.Equipo.getText(),
                            this.Vista.Cliente.getText(),
                            this.Vista.ci.getText(),
                            this.Vista.CamponombreFunc1.getText(),
                            this.Vista.CampoapeFunc.getText());
                } else {
...
//       this.Vista.jTextField6.setText("");
        ...
        this.Vista.CampoCod.setText("");
        this.Vista.CampoCodigo2.setText("");
        this.Vista.CODSERVICIO.setText("");
        this.Vista.CampoCodigoFun.setText("");
        this.Vista.CampoCodigoFun.setText("");
        this.Vista.CamponombreFunc1.setText("");
        this.Vista.CampoapeFunc.setText("");
//        this.Vista.Equipo.setText("");
        this.Vista.CODSERVICIO.setText("");
        this.Vista.Cliente.setText("");
        this.Vista.ci.setText("");
        this.Vista.CODSERVICIO.setText("");

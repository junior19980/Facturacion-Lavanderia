...
import modelo.MMedidaInsumo; 
import vista.VMedidaInsumo; 
import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;

public class CMedidaInsumo implements ActionListener, MouseListener, KeyListener {
     ...
     */
    MMedidaInsumo modelo = new MMedidaInsumo();
     ...
     */
    public CMedidaInsumo(VMedidaInsumo vista) {
        this.vista = vista;
    }

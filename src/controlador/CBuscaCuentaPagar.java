...
public class CBuscaCuentaPagar implements ActionListener, MouseListener, KeyListener {      
    /**
     * instancia a nuestra interfaz de usuario
     */
    VBuscaCuentaPagar vista;
    /**
     * instancia a nuestro modelo
     */
    MBuscaCuentaPagar modelo = new MBuscaCuentaPagar();
Macceso  m = new Macceso();
    /**
     ...
     */
    public CBuscaCuentaPagar(VBuscaCuentaPagar vista) {
        this.vista = vista;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.Camponom.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 1)));
                this.vista.telefono4.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,2)));
                this.vista.monto.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 3)));
                this.vista.contador.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,4)));
                           }
        }
    }
    ...
    public void iniciar() {
       // this.vista.Seleccionar1.setEnabled(false);
         //int ban=Integer.parseInt(m.nivel);
        //if(ban==1){
  ...
  //  this.vista.Seleccionar1.setActionCommand( "GUARDAR" );
   ...
   @Override
    ...
    public void limpiarCampos() {
        ...
        this.vista.Camponom.setText("");
        this.vista.contador.setText("");

...
public class cFormaPagoCuentaCobrar implements ActionListener {
 VAcceso vista;
 VBuscaCuentaCobrar dfd;
 cApertura apertura;
 MenuPrincipal.MenuPrincipalCajero venta;
    vFormaPagoCuentaCobrar Vista;
    mFormaPagoCuentaCobrar Modelo = new mFormaPagoCuentaCobrar();
Macceso modelo = new Macceso();
    ...
    public cFormaPagoCuentaCobrar(vFormaPagoCuentaCobrar Vista) {
        this.Vista = Vista;
    }
    public void iniciar() {
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cFormaPagoCuentaCobrar.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:

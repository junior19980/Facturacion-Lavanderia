...
public class CBuscaRecepcion implements ActionListener, MouseListener, KeyListener {

        
    /**
     * instancia a nuestra interfaz de usuario
     */
    VBuscaRecepcion vista;
    VAcceso Vista;
    /**
     * instancia a nuestro modelo
     */
    MBuscaResepcion  modelo = new MBuscaResepcion();
     ...
     */
    public CBuscaRecepcion(VBuscaRecepcion vista) {
        this.vista = vista;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.Fecha.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 1)));
                this.vista.ClienteNombre.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,2)));
                this.vista.Ci.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,3)));
                           }
        }
    }
   ...
   @Override
    ...
    public void limpiarCampos() {
        ...
        this.vista.ClienteNombre.setText("");
        this.vista.Ci.setText("");
    }

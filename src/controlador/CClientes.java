...
public class CClientes implements ActionListener, MouseListener, KeyListener {
     ...
     */
    public CClientes(VClientes vista) {
        this.vista = vista;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.CampoDescripcion2.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 3)));
                this.vista.CampoDescripcion3.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 4)));
                this.vista.CampoDescripcion4.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 5)));
                this.vista.codciudad.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 6)));
                this.vista.descriciudad.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 7)));
//                  this.vista.CampoDescripcion5.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 8)));
    ...
    public void iniciar() {
        ...
        this.vista.descriciudad.setEnabled(false);
           ...
           this.vista.CampoDescripcion2.setEnabled(false);
           this.vista.CampoDescripcion3.setEnabled(false);
           this.vista.CampoDescripcion4.setEnabled(false);
//           this.vista.CampoDescripcion5.setEnabled(false);
        ...
        switch (AccionMVC.valueOf(e.getActionCommand())) {
            ...
            case GUARDAR:
                ...
                if (this.modelo.Nuevo(
                        ...
                        this.vista.CampoDescripcion2.getText(),
                        this.vista.CampoDescripcion3.getText(),
                        this.vista.CampoDescripcion4.getText(),
                        this.vista.codciudad.getText()
//                        this.vista.CampoDescripcion5.getText()
...
this.vista.CampoDescripcion2.setText("");
this.vista.CampoDescripcion3.setText("");
this.vista.CampoDescripcion4.setText("");
//this.vista.CampoDescripcion5.setText("");
    }

...
public class cDebitoVenta implements ActionListener {

    VAcceso vista;
    public static String basura = "", usu;
    vDebitoVenta Vista;
    mApertura med = new mApertura();
    mDebitoVenta Modelo = new mDebitoVenta();
    ...
    public cDebitoVenta(vDebitoVenta Vista) {
        this.Vista = Vista;
    }
    ...
    public void iniciar() {
        ...
        this.Vista.jTextField2.setText("0");
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cDebitoVenta.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
            ...
            case GUARDAR:
                ...
                //tipofactura[0].trim()
                    ...
                    for (int i = 0; i < cantidadMercaderias; i++) {
                        ...
                        this.Modelo.RegistrarDetalleVenta(codigoMercadria, cantidad, precio);
                    }

...
import vista.VEmpresa; 
import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;

public class CEmpresa implements ActionListener, MouseListener, KeyListener {
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.codciudad4.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,6)));
                this.vista.descriciudad4.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,7)));

...
public class cFacturaCompra implements ActionListener {

    VAcceso vista;
    public static String basura = "";
    vFacturaCompra Vista;
    mFacturaCompra Modelo = new mFacturaCompra();
    ...
    public cFacturaCompra(vFacturaCompra Vista) {
        this.Vista = Vista;
    }
...
this.Modelo.generar_codigo();
        ...
        this.Vista.CampoFechaFactura.setText(lastdate);
        this.Vista.fechainicio.setText(lastdate);
        this.Vista.fechafin.setText(lastdate);
        ...
        switch (cServicioRealizado.AccionMVC.valueOf(e.getActionCommand())) {
            ...
            case GUARDAR:
                ...
                if (this.Modelo.RegistrarVenta(
                        ...
                        this.Vista.CampoNumFac.getText(),
                        tipofactura[0].trim(),
                        this.Vista.CampoCodProv.getText(),
                        this.Vista.CampoFecha.getText(),
                        this.Vista.CampoCodigoUsu.getText(),
                        this.Vista.CampoCodOrden.getText(),
                        this.Vista.TOTAL.getText(),
                        this.Vista.IVA.getText(),
                        this.Vista.mes.getText(),
                        this.Vista.CampoFechaFactura.getText(),
                        this.Vista.CampoTimbrado.getText()
                )) {
                    for (int i = 0; i < cantidadMercaderias; i++) {
                       ...
                       // this.Modelo.descontarstock(codigoMercadria, cantidad);
                    }
...
//       this.Vista.jTextField6.setText("");
        this.Vista.CampoCodProv.setText("");
        ...
        this.Vista.CampoTimbrado.setText("");
        this.Vista.CampoTimbrado.setText("");
        this.Vista.CampoCodOrden.setText("");
        this.Vista.Seleccionar.setEnabled(false);
    }

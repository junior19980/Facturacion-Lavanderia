...
public class cFormaPago implements ActionListener {
    VAcceso vista;
     VBuscaCuentaCobrar dfd;
    cApertura apertura;
    cFacturaVenta venta;
    vFormaPago Vista;
    mFormaPago Modelo = new mFormaPago();
Macceso modelo = new Macceso();
    ...
    public cFormaPago(vFormaPago Vista) {
        this.Vista = Vista;
    }
    public void iniciar() {
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cFormaPago.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
		this.Vista.CampoCodigo1.setText(venta.idFactura);

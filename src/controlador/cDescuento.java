...
import modelo.mDescuento;
import vista.vDescuento;
public class cDescuento implements ActionListener, MouseListener, KeyListener {
    /**
     ...
     */
    mDescuento modelo = new mDescuento();
     ...
     */
    public cDescuento(vDescuento vista) {
        this.vista = vista;
    }

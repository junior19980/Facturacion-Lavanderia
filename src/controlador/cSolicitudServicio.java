...
public class cSolicitudServicio implements ActionListener {
    vSolicitudServicio Vista;
    mSolicitudServicio Modelo = new mSolicitudServicio();
Macceso modelo = new Macceso();
    ...
    public cSolicitudServicio(vSolicitudServicio Vista) {
        this.Vista = Vista;
    }
    public void iniciar() {
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cSolicitudServicio.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
            ...
            case GUARDAR:
              ...
              //  String tipofactura[] = this.vista.ComboTipoFactura.getSelectedItem().toString().split("-");
                ...
                if (this.Modelo.RegistrarVenta(
                  ...
                  //   this.Modelo.Reportes("SolicitudServicio", this.Vista.TablaDetalle, this.Vista.CampoCodigo.getText(),
	...
	//	this.Vista.DescriEquipo.setText("");

...
public class CBuscaFacturaCompra implements ActionListener, MouseListener, KeyListener {
     /**
     * instancia a nuestra interfaz de usuario
     */
    VBuscaFacturaCompra vista;
    /**
     * instancia a nuestro modelo
     */
    MBuscaFacturaCompra  modelo = new MBuscaFacturaCompra();
    /**
     ...
     */
    public CBuscaFacturaCompra(VBuscaFacturaCompra vista) {
        this.vista = vista;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.CampoNro.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 1)));
                this.vista.NombreProv.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,2)));
                 this.vista.RucProv.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,3)));
                           }
        }
    }
    @Override

...
public class CInsumo implements ActionListener, MouseListener, KeyListener {
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.CampoDescripcion.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 1)));
                 this.vista.codciudad5.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 2)));
                 this.vista.codciudad3.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 3)));
		...
		this.vista.codciudad.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,8)));
                this.vista.descriciudad.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,9)));
            }
        }
    }
...
this.vista.codciudad5.setEnabled(false);

...
public class CProveedor implements ActionListener, MouseListener, KeyListener {
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.CampoDescripcion4.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 4)));
                this.vista.codciudad.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 5)));
                this.vista.descriciudad.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 6)));

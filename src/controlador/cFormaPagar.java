...
public class cFormaPagar implements ActionListener {
 VAcceso vista;
 VBuscaCuentaPagar dfd;
 cApertura apertura;
 cFacturaVenta venta;
    vFormaPagoPagar Vista;
    mFormaPagar Modelo = new mFormaPagar();
Macceso modelo = new Macceso();
    ...
    public cFormaPagar(vFormaPagoPagar Vista) {
        this.Vista = Vista;
    }
    public void iniciar() {
...
//	this.Vista.jTextField3.setText(this.venta.apertura);
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cFormaPagar.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
		this.Vista.CampoCodigo1.setText(venta.idFactura);

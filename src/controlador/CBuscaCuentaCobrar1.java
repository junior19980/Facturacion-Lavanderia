...
public class CBuscaCuentaCobrar1 implements ActionListener, MouseListener, KeyListener {      
    /**
     * instancia a nuestra interfaz de usuario
     */
    VBuscaCuentaCobrar1 vista;
    /**
     * instancia a nuestro modelo
     */
    MBuscaCuentaCobrar1  modelo = new MBuscaCuentaCobrar1();
Macceso  m = new Macceso();
     ...
     */
    public CBuscaCuentaCobrar1(VBuscaCuentaCobrar1 vista) {
        this.vista = vista;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.CampoDescripcion.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 2)));
                this.vista.telefono2.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,3)));
                           }
        }
    }

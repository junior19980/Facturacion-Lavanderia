...
import modelo.MMarcaVehiculo; 
import vista.VMarcaVehiculo; 
import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;

public class CMarcaVehiculo implements ActionListener, MouseListener, KeyListener {

    /**
     * instancia a nuestra interfaz de usuario
     */
    VMarcaVehiculo vista;
    /**
     * instancia a nuestro modelo
     */
    MMarcaVehiculo modelo = new MMarcaVehiculo();
     ...
     */
    public CMarcaVehiculo(VMarcaVehiculo vista) {
        this.vista = vista;
    }

...
public class CBuscaInsumo implements ActionListener, MouseListener, KeyListener {
    /**
     ...
     */
    MBuscaInsumo  modelo = new MBuscaInsumo();
     ...
     */
    public CBuscaInsumo(VBuscaInsumo vista) {
        this.vista = vista;
    }

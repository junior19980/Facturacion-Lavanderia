...
import modelo.MMarcaInsumo; 
import vista.VMarcaInsumo; 
import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;

public class CMarcaInsumo implements ActionListener, MouseListener, KeyListener {
     ...
     */
    MMarcaInsumo modelo = new MMarcaInsumo();
     ...
     */
    public CMarcaInsumo(VMarcaInsumo vista) {
        this.vista = vista;
    }

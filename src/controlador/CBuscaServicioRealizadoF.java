...
public class CBuscaServicioRealizadoF implements ActionListener, MouseListener, KeyListener {

        
    /**
     * instancia a nuestra interfaz de usuario
     */
    VBuscaServicioRalizadoF vista;
    VAcceso Vista;
    /**
     * instancia a nuestro modelo
     */
    MBuscaServicioRealizadoF modelo = new MBuscaServicioRealizadoF();
     ...
     */
    public CBuscaServicioRealizadoF(VBuscaServicioRalizadoF vista) {
        this.vista = vista;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.idcliente.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 5)));
                this.vista.cliente.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,6)));
                 this.vista.ci.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,7)));
                           }
        }
    }

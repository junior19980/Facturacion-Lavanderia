...
import modelo.MAnularResepcion; 
import vista.VAnularResepcion; 
import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;

public class CAnularResepcion implements ActionListener, MouseListener, KeyListener {

    /**
     * instancia a nuestra interfaz de usuario
     */
    VAnularResepcion vista;
    /**
     * instancia a nuestro modelo
     */
    MAnularResepcion modelo = new MAnularResepcion();
     ...
     */
    public CAnularResepcion(VAnularResepcion vista) {
        this.vista = vista;
    }
        ...
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.CampoDescripcion4.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 5)));
                  this.vista.CampoDescripcion5.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 6)));

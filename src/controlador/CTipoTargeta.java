...
import modelo.MTipoTargeta;
import vista.VTipoTargeta; 
import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;

public class CTipoTargeta implements ActionListener, MouseListener, KeyListener {
     ...
     */
    MTipoTargeta modelo = new MTipoTargeta();
     ...
     */
    public CTipoTargeta(VTipoTargeta vista) {
        this.vista = vista;
    }

...
public class CBuscaCobros implements ActionListener, MouseListener, KeyListener {
     ...
     */
    MBuscaCobros modelo = new MBuscaCobros();
     ...
     */
    public CBuscaCobros(VBuscaCobros vista) {
        this.vista = vista;
    }

...
public class cDiagnostico implements ActionListener {
    vDiagnostico Vista;
    mDiagnostico Modelo = new mDiagnostico();
Macceso modelo = new Macceso();
    ...
    public cDiagnostico(vDiagnostico Vista) {
        this.Vista = Vista;
    }
    public void iniciar() {
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cDiagnostico.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
            ...
            case GUARDAR:
              ...
              //  String tipofactura[] = this.vista.ComboTipoFactura.getSelectedItem().toString().split("-");
                ...
                if (this.Modelo.RegistrarVenta(
                  ...
                  //   this.Modelo.Reportes("Diagnostico", this.Vista.TablaDetalle, this.Vista.CampoCodigo.getText(),

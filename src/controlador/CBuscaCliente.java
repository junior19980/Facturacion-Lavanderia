...
public class CBuscaCliente implements ActionListener, MouseListener, KeyListener {
     ...
     */
    MBuscaCliente  modelo = new MBuscaCliente();
     ...
     */
    public CBuscaCliente(VBuscaCliente vista) {
        this.vista = vista;
    }

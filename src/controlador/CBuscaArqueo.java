...
public class CBuscaArqueo implements ActionListener, MouseListener, KeyListener {      
    /**
     ...
     */
    MBuscaArqueo  modelo = new MBuscaArqueo();
Macceso  m = new Macceso();
     ...
     */
    public CBuscaArqueo(VBuscaArqueo vista) {
        this.vista = vista;
    }

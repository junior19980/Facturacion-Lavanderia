...
public class cOrdenCompra implements ActionListener {
 VAcceso vista;
 vOrdenCompra Vista;
    mOrdenCompra Modelo = new mOrdenCompra();
Macceso modelo = new Macceso();
    ...
    public cOrdenCompra(vOrdenCompra Vista) {
        this.Vista = Vista;
    }
    public void iniciar() {
...
//          this.Vista.jButton1.setEnabled(false);
         this.Vista.SeleccionarPedidos.setEnabled(false);
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cOrdenCompra.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
                ...
                if (this.Modelo.Registrar(
                    ...
                    for (int i = 0; i < cantidadMercaderias; i++) {
                        String codigoMercadria = tabla3.getValueAt(i,0).toString();
                         String idorden= this.Vista.CampoCodigo.getText();
                        String canti =  tabla3.getValueAt(i,3).toString();
                        
                        this.Modelo.RegistrarDetalle(codigoMercadria, idorden, canti);
                    }
                    JOptionPane.showMessageDialog(Vista, "Exito: Nuevo registro agregado.");
                            this.Modelo.Reportes("OrdenCompra", this.Vista.TablaDetalle, this.Vista.CampoCodigo.getText(),
                           this.Vista.CampoCodigo1.getText(), this.Vista.CampoCodigo2.getText(),
                           this.Vista.jTextField1.getText(), this.Vista.jTextField2.getText(),

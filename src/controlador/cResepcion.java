...
public class cResepcion implements ActionListener {

    vResepcion Vista;
    mResepcion Modelo = new mResepcion();
    ...
    public cResepcion(vResepcion vista) {
        this.Vista = vista;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cResepcion.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
            ...
            case GUARDAR:
                ...
                if (this.Modelo.RegistrarVenta(
                    ...
                    this.Modelo.Reportes("resepcion", this.Vista.TablaDetalle,
                             this.Vista.CampoCodigo.getText(),
                            this.Vista.CampoCodigo1.getText(),
            ...
            case AGREGAR_DETALLE:
                ...
                if (this.Modelo.cargarDatos(this.Vista.CODSERVICIO.getText().trim(), this.Vista.SERVICIO.getText().trim(), this.Vista.CODSERVICIO1.getText().trim(), tabla)) {
...
//   this.Vista.jTextField2.setText("");
    ...
    public void limpia() {
        this.Vista.CODSERVICIO1.setText("");

...
public class cPresupuestoProveedor implements ActionListener {
 VAcceso vista;
    vPresupuestoProveedor Vista;
    mPresupuestoProveedor Modelo = new mPresupuestoProveedor();
Macceso modelo = new Macceso();
    ...
    public cPresupuestoProveedor(vPresupuestoProveedor Vista) {
        this.Vista = Vista;
    }
    public void iniciar() {
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cPresupuestoProveedor.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
              ...
              //  String tipofactura[] = this.vista.ComboTipoFactura.getSelectedItem().toString().split("-");
                ...
                if (this.Modelo.RegistrarVenta(
                    ...
                    for (int i = 0; i < cantidadMercaderias; i++) {
                        ...
                        String dia = tabla3.getValueAt(i, 3).toString();
                        this.Modelo.RegistrarDetalleVenta(codigoMercadria,cantidad,dia);
                    }
                    JOptionPane.showMessageDialog(Vista, "Exito: Nuevo registro agregado.");
                   /*  this.Modelo.Reportes("Presupuesto", this.Vista.TablaDetalle, this.Vista.CampoCodigo.getText(),
            ...
            case SALIR:
                ...
                if (this.Modelo.cargarDatos(this.Vista.CODSERVICIO.getText().trim(),this.Vista.SERVICIO.getText().trim(),this.Vista.SERVICIO1.getText(),this.Vista.CANTIDAD.getText(), tabla)) {

...
import modelo.MCategoriaVehiculo; 
import vista.VCategoriaVehiculo; 
import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;

public class CCategoria implements ActionListener, MouseListener, KeyListener {

    /**
     * instancia a nuestra interfaz de usuario
     */
    VCategoriaVehiculo vista;
    /**
     * instancia a nuestro modelo
     */
    MCategoriaVehiculo modelo = new MCategoriaVehiculo();
     ...
     */
    public CCategoria(VCategoriaVehiculo vista) {
        this.vista = vista;
    }

...
public class CBuscaFacturaEntrega implements ActionListener, MouseListener, KeyListener {

        
    /**
     * instancia a nuestra interfaz de usuario
     */
    VBuscaFacturaEntrega vista;
    VAcceso Vista;
    /**
     * instancia a nuestro modelo
     */
    MBuscaFacturaEntrega modelo = new MBuscaFacturaEntrega();
     ...
     */
    public CBuscaFacturaEntrega(VBuscaFacturaEntrega vista) {
        this.vista = vista;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.cliente.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,1)));
                 this.vista.ci.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,2)));
                this.vista.Campoidserv.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 3)));
                this.vista.servicio.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila,4)));

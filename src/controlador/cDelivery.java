...
public class cDelivery implements ActionListener {
      vDelivery Vista;
    mDelivery Modelo = new mDelivery();
Macceso modelo = new Macceso();
    ...
    public cDelivery(vDelivery Vista) {
        this.Vista = Vista;
    }
    public void iniciar() {
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cDelivery.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
              ...
              //  String tipofactura[] = this.vista.ComboTipoFactura.getSelectedItem().toString().split("-");
                ...
                if (this.Modelo.RegistrarVenta(
                    ...
                    JOptionPane.showMessageDialog(Vista, "Exito: Nuevo registro agregado.");
                              //   this.Modelo.Reportes("OrdenTrabajo", this.Vista.TablaDetalle, this.Vista.CampoCodigo.getText(), this.Vista.CampoCodigo1.getText(),
                                //this.Vista.CampoCodigo2.getText(), this.Vista.jTextField1.getText(),this.Vista.jTextField2.getText(), this.Vista.jTextField3.getText(),
            ...
            case SALIR:
                ...
                if (this.Modelo.cargarDatos(this.Vista.CODSERVICIO.getText().trim(),this.Vista.SERVICIO.getText().trim(),this.Vista.SERVICIO1.getText().trim(),this.Vista.CANTIDAD.getText(), tabla)) {

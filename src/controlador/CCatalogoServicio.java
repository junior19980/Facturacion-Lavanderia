...
import modelo.MCatalogoServicio;
import vista.VCatalogoServicio; 
import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;
public class CCatalogoServicio implements ActionListener, MouseListener, KeyListener {
    /**
     * instancia a nuestra interfaz de usuario
     */
    VCatalogoServicio vista;
    /**
     * instancia a nuestro modelo
     */
    MCatalogoServicio modelo = new MCatalogoServicio();
     ...
     */
    public CCatalogoServicio(VCatalogoServicio vista) {
        this.vista = vista;
    }
      ...
      this.vista.CampoDescripcion.setEnabled(false);
       ...
       this.vista.CampoDescripcion1.setEnabled(false);
            ...
            case CANCELAR:
                ...
                break;
            case INFORME:
                modelo.Reportes("CatalogoServicio");
                break;
        }
    }

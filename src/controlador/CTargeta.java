...
import modelo.MTargeta; 
import vista.VTargeta; 
import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;

public class CTargeta implements ActionListener, MouseListener, KeyListener {
     ...
     */
    public CTargeta(VTargeta vista) {
        this.vista = vista;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == 1) {
            ...
            if (fila > -1) {
                ...
                this.vista.descriciudad.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 5)));
                this.vista.codciudad1.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 6)));
                this.vista.descriciudad1.setText(String.valueOf(this.vista.TablaConsulta.getValueAt(fila, 7)));
            }
        }
    }

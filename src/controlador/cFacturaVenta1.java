...
public class cFacturaVenta1 implements ActionListener {
 VAcceso vista;
    public static  String basura="",usu,idFactura="",apertura="";
public static int total;
    vFacturaVenta1 Vista;
	cAperturaCierreArqueo med;
    mFacturaVenta1 Modelo = new mFacturaVenta1();
Macceso modelo = new Macceso();
    ...
    public cFacturaVenta1(vFacturaVenta1 Vista) {
        this.Vista = Vista;
    }
    public void iniciar() {
	...
	this.Vista.CampoCodigo7.setText(this.med.idAperturaCaja);	
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cFacturaVenta1.AccionMVC.valueOf(e.getActionCommand())) {
            case AGREGAR:
     //   this.Vista.jComboBox2.setModel(this.Modelo.getListaTipoFacturas());
            ...
            case GUARDAR:
                ...
                if (this.Modelo.RegistrarVenta(
                    ...
                    for (int i = 0; i < cantidadMercaderias; i++) {
                        ...
                        this.Modelo.RegistrarDetalleVenta(codigoMercadria,precio,cantidad,subtotal);
    ...
    public void limpiarcampos() {
        this.Vista.jTextField1.setText("0.0");
        this.Vista.jTextField2.setText("0.0");
